...
{
    [Area("Admin")]
    public class StandardsOldController : Controller
    {
        [Obsolete]
        ...
        public StandardsOldController(IStudentService studentService, AppDbContext context, ISessionYearService sessionService, IStandardService standardService)
        {
